// NOTE: Please update this type as and when new operations are being supported
/**
 * The type for the list of operations currently supported by the calculator.
 * @typedef {('DEL' | 'AC' | '=' | '+')} OperationsType
 */
